...
<div id="first">   
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content"><BR>
              <span class="info-box-text">RMS Current</span>
              <span class="info-box-number"><?echo $nrow['rms_c']; ?><small>A</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content"><BR>
              <span class="info-box-text">RMS POWER</span>
              <span class="info-box-number"><?echo $nrow['rms_p']; ?><small>W</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content"><BR>
              ...
              <span class="info-box-number"><?echo $nrow['kilos']; ?><small>Units</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-yellow"><i class="  fa fa-compass"></i></span>

            <div class="info-box-content"><BR>
              <span class="info-box-text">PEAK POWER</span>
              <span class="info-box-number"><?echo $nrow['peak_p']; ?><small>W</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"> 
        Meter details
        <small>details of the table</small>
      </h3>
                      ...
                      <div class="col-xs-12">
                        <div class="box">
                          ...
                          <div class="box-body">
                              ...
                              $queryn = "SELECT * from quater_master where meter_id = '$meter_id'";
                            
                              $finaln = mysqli_query($link,$queryn); 
                              
                              $nrow   = mysqli_fetch_array($finaln,MYSQL_ASSOC); 
                              

                              echo" Meter Number is ";
                              echo $nrow['meter_id'];
                              echo "<div class=pull-right>";
                              echo" Name of the Owner : ";
                              echo "<td>" .$nrow['name']. "</td>";
                              echo "</div>";
                              ?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017-2018 <a href="#">Bumfuzzlers</a>.</strong> All rights
    reserved.
  </footer>
